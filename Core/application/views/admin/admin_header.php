				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span><?php $user = $this->ion_auth->user()->row(); echo ucfirst($user->username); ?> <i class="caret"></i></span>
						</a>
						<ul class="dropdown-menu">
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="<?php echo base_url();?>auth/create_user" class="btn btn-default btn-flat">Create User</a>
								</div>
